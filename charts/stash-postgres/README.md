...
$ helm repo update
$ helm install stash-postgres-10.6-rc.20200827 appscode/stash-postgres -n kube-system --version=10.6-rc.20200827
```
...
To install the chart with the release name `stash-postgres-10.6-rc.20200827`:
...
To uninstall/delete the `stash-postgres-10.6-rc.20200827`:

```console
$ helm delete stash-postgres-10.6-rc.20200827 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore PostgreSQL database. This is usually same as the database version it can backup. | `10.6-rc.20200827` |
...
```console
$ helm install stash-postgres-10.6-rc.20200827 appscode/stash-postgres -n kube-system --version=10.6-rc.20200827 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.6-rc.20200827 appscode/stash-postgres -n kube-system --version=10.6-rc.20200827 --values values.yaml
```

...
$ helm repo update
$ helm install stash-postgres-10.2-beta.20200709 appscode/stash-postgres -n kube-system --version=10.2-beta.20200709
```
...
To install the chart with the release name `stash-postgres-10.2-beta.20200709`:
...
To uninstall/delete the `stash-postgres-10.2-beta.20200709`:

```console
$ helm delete stash-postgres-10.2-beta.20200709 -n kube-system
```
...
```console
$ helm install stash-postgres-10.2-beta.20200709 appscode/stash-postgres -n kube-system --version=10.2-beta.20200709 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.2-beta.20200709 appscode/stash-postgres -n kube-system --version=10.2-beta.20200709 --values values.yaml
```

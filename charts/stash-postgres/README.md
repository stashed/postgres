...
To install the chart with the release name `stash-postgres-10.6`:
...
To uninstall/delete the `stash-postgres-10.6`:

```console
$ helm delete stash-postgres-10.6 -n kube-system
```
...
```console
$ helm install stash-postgres-10.6 appscode/stash-postgres -n kube-system --version=10.6 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.6 appscode/stash-postgres -n kube-system --version=10.6 --values values.yaml
```

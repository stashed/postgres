...
$ helm repo update
$ helm install stash-postgres-10.2-rc.20200826 appscode/stash-postgres -n kube-system --version=10.2-rc.20200826
```
...
To install the chart with the release name `stash-postgres-10.2-rc.20200826`:
...
To uninstall/delete the `stash-postgres-10.2-rc.20200826`:

```console
$ helm delete stash-postgres-10.2-rc.20200826 -n kube-system
```
...
| image.tag        | Tag of the image that is used to backup/restore PostgreSQL database. This is usually same as the database version it can backup. | `10.2-rc.20200826` |
...
```console
$ helm install stash-postgres-10.2-rc.20200826 appscode/stash-postgres -n kube-system --version=10.2-rc.20200826 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.2-rc.20200826 appscode/stash-postgres -n kube-system --version=10.2-rc.20200826 --values values.yaml
```

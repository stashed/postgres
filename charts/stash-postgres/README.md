...
```console
helm uninstall stash-postgres-11.2 -n kube-system
```
...
```console
helm install stash-postgres-11.2 appscode/stash-postgres -n kube-system --set docker.registry=my-registry
```

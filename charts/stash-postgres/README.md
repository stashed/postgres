...
$ helm repo update
$ helm install stash-postgres-10.2-beta.20200708 appscode/stash-postgres -n kube-system --version=10.2-beta.20200708
```
...
To install the chart with the release name `stash-postgres-10.2-beta.20200708`:
...
To uninstall/delete the `stash-postgres-10.2-beta.20200708`:

```console
$ helm delete stash-postgres-10.2-beta.20200708 -n kube-system
```
...
```console
$ helm install stash-postgres-10.2-beta.20200708 appscode/stash-postgres -n kube-system --version=10.2-beta.20200708 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.2-beta.20200708 appscode/stash-postgres -n kube-system --version=10.2-beta.20200708 --values values.yaml
```

...
To install the chart with the release name `stash-postgres-10.2`:
...
To uninstall/delete the `stash-postgres-10.2`:

```console
$ helm delete stash-postgres-10.2 -n kube-system
```
...
```console
$ helm install stash-postgres-10.2 appscode/stash-postgres -n kube-system --version=10.2 --set image.registry=stashed
```
...
```console
$ helm install stash-postgres-10.2 appscode/stash-postgres -n kube-system --version=10.2 --values values.yaml
```
